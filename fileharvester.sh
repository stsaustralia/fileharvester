...
TARGET_DIR="/Users/Shared/SaveCombo/1"

# Logging
LOG_TO_FILE=true
LOG_FILE="/Users/Shared/SaveCombo/harvest_combined.log"
...
MIN_SIZE_BYTES=0                  # e.g. 1024 for 1 KiB; 0 disables min
MAX_SIZE_BYTES=$((32*1024*1024)) # 32 MiB; set 0 to disable max
...
now() {
  # Produce UTC then add +10h to format as Sydney (fixed, no DST as per your policy)
  # Using -u with +10H ensures stable +10 offset.
